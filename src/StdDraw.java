/*************************************************************************
 * Biblioteca de desenho padr�o. Essa classe fornece uma capacidade b�sica para
 * cria��o de desenhos com seus programas. Ele usa um modelo de gr�ficos simples 
 * que permitecriar desenhos que consistem em pontos, linhas e curvas
 * em uma janela no seu computador e salvar os desenhos em um arquivo.
 *
 * Todo
 * ----
 * - Adicionar suporte para preenchimento de gradiente, etc
 *
 * Observa��es
 * -------
 * - N�o use AffineTransform para redimensionando uma vez que inverte
 * imagens e strings
 * - Cuidado com setFont em loop interno dentro de uma anima��o -
 * Pode causar cintila��o - agita��o de brilho , cor, luz.
 *
 *************************************************************************/
